...
| [`docs/superpowers/specs/`](docs/superpowers/specs/) | 规则审计、Digest、架构与 Phase 1 计划 |
| `rm-sim/` | 裁判、仿真、Isaac 与训练包 |
| [`AGENTS.md`](AGENTS.md) | 贡献流程与仓库约定 |

建议依次阅读 [PDF 审计](docs/superpowers/specs/2026-07-23-rmuc-v1.5.0-pdf-audit.md)、[规则 Digest](docs/superpowers/specs/2026-07-23-rmuc-rules-digest.md)和[实现计划](docs/superpowers/specs/2026-07-23-rmuc-implementation-plan.md)。
